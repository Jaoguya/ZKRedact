...
LABELS: Dict[str, str] = {
    ...
    # as [6]/[7]/[15]. Keys stay put because they name the implementations.
    "ref10_emt": "Ref[6] EMT (in-process)",
    "ref10_emt/fabric": "Ref[6] EMT (Fabric)",
    "ref13_vrbc": "Ref[7] VRBC",
    "ref22_shen": "Ref[15] Shen",
}
